const simpleTemplate = (data, color) => {
  ...
  return {
    ...
    styles: {
      header: { fontSize: 12.1, bold: true, color: palette.text, margin: [0, 0, 0, 2] },
      subheader: {
        fontSize: 8.3,
        bold: true,
      ...
      tableHeader: { bold: true, color: hasColor ? "white" : palette.text, fontSize: 7.7, margin: [0, 1, 0, 1] },
      ...
      partyName: { bold: true, fontSize: 9.4, color: palette.text, margin: [0, 0, 0, 2] },
